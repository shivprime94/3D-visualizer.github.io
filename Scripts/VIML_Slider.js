function VIML_Slider() {
    ...
    this.setValue = function (a) {
        ...
        this
            .priSlider
            .slider("option", "value", fValue);
        this.priValueWidget.value = this
            .priSlider
            .slider("option", "value")
            .toFixed(this.priFix);
    ...
    this.setRange = function (c, a) {
        ...
        this
            .priSlider
            .slider("option", "min", parseFloat(b));
        b = parseFloat(a);
        ...
        this
            .priSlider
            .slider("option", "max", parseFloat(b));
        this.priDrawTick();
    ...
    this.priTimer = function () {
        switch (parseInt(this.priWMode.value)) {
            ...
            case 2:
                ...
                if (this.priCurrentValue > this.priRange[1] || this.priCurrentValue < this.priRange[0]) {
